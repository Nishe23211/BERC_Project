...
public class SupportStaff1 {
    ...
    @javafx.fxml.FXML
    private TableColumn<SupportStaffU1, String> logcolumn;
    @javafx.fxml.FXML
    ...
    public void onFilter(ActionEvent actionEvent) {
        String LogId = logidfield.getText();
    ...
    public void onViewLogDetails(ActionEvent actionEvent) throws IOException {
        SupportStaffU1 selectedLog = tableview.getSelectionModel().getSelectedItem();

        if (selectedLog == null) {
            logsText.setText("Please select a log to view details.");
        } else {
